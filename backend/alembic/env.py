...
# Set db url from settings (force sync driver for migrations)
...
if "sqlite:///" in db_url and "/./data/" in db_url:
    base_dir = os.getcwd()
    if not os.path.exists(os.path.join(base_dir, "data")) and os.path.exists(os.path.join(base_dir, "..", "data")):
