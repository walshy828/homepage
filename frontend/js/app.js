                ...
                <nav class="app-sidebar-nav ${sidebarCollapsed ? 'collapsed' : ''}" id="app-sidebar">
                    ...
                    <div class="sidebar-nav">
                        ...
                        <div class="sidebar-section">
                            ...
                            <div class="sidebar-item" onclick="app.openSettings(); app.closeMobileSidebar();" title="Settings (G then S)">
                                ...
                                <span class="sidebar-item-shortcut">G→S</span>
                            </div>
            ...
            <div class="keyboard-help-modal">
                ...
                <div class="keyboard-help-body">
                    <div class="keyboard-section">
                        ...
                        <div class="keyboard-shortcut-row">
                            <span class="keyboard-shortcut-label">Go to Settings</span>
                            <span class="keyboard-shortcut-keys"><span class="key">G</span><span class="key-arrow">→</span><span class="key">S</span></span>
                        </div>
                    </div>
